                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse show" data-parent="#accordionSidebar">
                                    <li class="active"><a href="../module/workoutclass.php">Program </a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="breadcrumbs-area clearfix" style="margin-top:  10px;">
                            <h4 class="page-title pull-left">Program </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body"><button type="button" class="btn btn-success btn-xs mb-3"
                                ...
                                <h4 class="header-title" style="margin-top: -30px;">Program </h4>
                                <?php
                                    ...
                                    $pdo->setAttribute (PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                        ...
                                        $statement->execute();
                                        $workoutclasses = $statement->fetchAll(PDO::FETCH_ASSOC);
                                    ?>
                            ...
                            ?>
                                    <table id="example" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php foreach($workoutclasses as $i => $workoutclass): ?>
                                            <tr>
                                                <td><?php echo $workoutclass['workoutclass_name'];?></td>
                                                <!-- <td><?php $date = date("H:i A", strtotime($workoutclass['time'])); echo $date; ?>
                                                </td> -->
                                                <td>
                                                    <div class="readmore less" id="desc">
                                                        <?php echo $workoutclass['workoutclass_description'];?>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-success btn-xs mb-3"
                                                        ...
                                                        title="View"
                                                        data-target="#view-<?php echo $workoutclass['workoutclass_id'];?>"><i
                                                            class="fa fa-eye"> </i> </button>
                                                    <!--View button start here-->

                                                    <!-- View MODAL STARTS HERE -->
                                                    <div class="modal fade"
                                                        id="view-<?php echo $workoutclass['workoutclass_id'];?>"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="staticBackdropLabel">View Program </h5>
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="input-group mb-3">
                                                                                <div class="input-group-prepend">
                                                                                    <span
                                                                                        class="input-group-text">Program
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    ...
                                                                                    id="workoutclass"
                                                                                    name="workoutclass <?php echo $workoutclass['workoutclass_id']; ?>"
                                                                                    disabled
                                                                                    value="<?php echo $workoutclass['workoutclass_id']; ?>">
                                                                            ...
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    ...
                                                                                    id="workoutclassname"
                                                                                    name="workoutclassname <?php echo $workoutclass['workoutclass_name']; ?>"
                                                                                    disabled
                                                                                    value="<?php echo $workoutclass['workoutclass_name']; ?>">
                                                                            </div>

                                                                            <!-- <div class="input-group mb-3">
                                                                                <div class="input-group-prepend">
                                                                                    <span
                                                                                        class="input-group-text">Time</span>
                                                                                </div>
                                                                                <input type="time" class="form-control"
                                                                                    aria-describedby="basic-addon3"
                                                                                    id="time"
                                                                                    name="time <?php echo $workoutclass['time']; ?>"
                                                                                    disabled
                                                                                    value="<?php $date = date("H:i", strtotime($workoutclass['time'])); echo $date; ?>">
                                                                            </div> -->
                                                                            <div class="input-group-prepend">
                                                                                <span
                                                                                    class="input-group-text">Description</span>
                                                                                <textarea type="text"
                                                                                    name="workoutclassdescription-<?php echo $workoutclass['workoutclass_description']; ?>"
                                                                                    disabled
                                                                                    class="form-control"><?php echo $workoutclass['workoutclass_description'];?></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-xs mb-3"
                                                        data-toggle="modal" data-toggle="tooltip" data-placement="top"
                                                        title="Edit"
                                                        data-target="#edit-<?php echo $workoutclass['workoutclass_id'];?>"><i
                                                    ...
                                                    <div class="modal fade" data-backdrop="static" data-keyboard="false"
                                                        ...
                                                        id="edit-<?php echo $workoutclass['workoutclass_id'];?>"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    aria-describedby="basic-addon3"
                                                                                    id="workoutclass_id" disabled
                                                                                    value="<?php echo $workoutclass['workoutclass_id']; ?>">
                                                                                <input type="hidden"
                                                                                    class="form-control"
                                                                                    aria-describedby="basic-addon3"
                                                                                    id="workoutclass_id"
                                                                                    name="workoutclass_id"
                                                                                    value="<?php echo $workoutclass['workoutclass_id']; ?>">
                                                                            ...
                                                                            <!-- <div class="input-group mb-3">
                                                                                ...
                                                                                <input type="time" class="form-control"
                                                                                    ...
                                                                                    value="<?php echo $workoutclass['time']; ?>">
                                                                            </div> -->


                                                                            <textarea type="text" class="form-control"
                                                                                name="workoutclassdescription"
                                                                                class="form-control"><?php echo $workoutclass['workoutclass_description'];?></textarea>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-xs mb-3"
                                                        data-toggle="modal" data-toggle="tooltip" data-placement="top"
                                                        title="Delete"
                                                        data-target="#delete-<?php echo $workoutclass['workoutclass_id'];?>"><i
                                                            class="fa fa-trash"> </i> </button>
                                                    <!--Delete button start here-->

                                                    <!-- DELETE MODALS START HERE -->
                                                    <div id="delete-<?php echo $workoutclass['workoutclass_id'];?>"
                                                        ...
                                                        <div class="modal-dialog modal-confirm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer justify-content-center">
                                                                    <form class="d-inline"
                                                                        action="../workout_class/deleteworkoutClass.php"
                                                                        method="post">
                                    ...
                                    <div class="modal fade" id="add" aria-hidden="true" style="display: none;"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <form class="needs-validation" novalidate
                                                action="../workout_class/addworkoutClass.php" method="post">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <?php
                                                    ...
                                                    $a = new Admin();
                                                    ?>
                                                        <h5 class="modal-title" id="staticBackdropLabel">Add Program
                                                        </h5>
                                                        <button type="button" class="close"
                                                            data-dismiss="modal"><span>×</span></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">ProgramID</span>
                                                                </div>
                                                                <input type="text" class="form-control"
                                                                    aria-describedby="basic-addon3" id="workoutclass"
                                                                    name="" value="<?php 
                                                    echo $a->generateGroupId();?>" disabled>
                                                                <input type="hidden" class="form-control"
                                                                    aria-describedby="basic-addon3" id="workoutclass"
                                                                    name="workoutclass_id" value="<?php 
                                                    echo $a->generateGroupId();?>">
                                                            </div>
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text"> Program Name
                                                                        <span>&nbsp;</span><span style="color: red;"> *
                                                                        </span></span>
                                                                </div>
                                                                <input type="text" class="form-control" required
                                                                    aria-describedby="basic-addon3"
                                                                    placeholder="Program Name" id="workoutclassname"
                                                                    name="workoutclassname">
                                                            ...
                                                            <!-- <div class="input-group mb-3">
                                                                ...
                                                                <input type="time" 2 id="timeInput" class="form-control"
                                                                    name="time" required
                                                                    aria-describedby="basic-addon3">
                                                            ...
                                                            <textarea class="form-control" aria-label="With textarea"
                                                                rows="5" name="workoutclassdescription"
