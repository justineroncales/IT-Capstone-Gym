...
<body>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse show">
                                    ...
                                    <li class="active"><a href="../module/discount.php">Discount</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="breadcrumbs-area clearfix" style="margin-top:  10px;">
                            <h4 class="page-title pull-left">Discount </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body"><button type="button" class="btn btn-success btn-xs mb-3"
                                ...
                                <h4 class="header-title" style="margin-top: -30px;">Discount </h4>
                                <?php
                                    $pdo = New PDO ('mysql:host=localhost;port=3306;dbname=fitstop_db', 'root', '' );
                                    $pdo->setAttribute (PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                        $statement = $pdo->prepare('SELECT * FROM tbl_discount');
                                        $statement->execute();
                                        $discountclasses = $statement->fetchAll(PDO::FETCH_ASSOC);
                                    ?>
                            ...
                            ?>
                                    <table id="example" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php foreach($discountclasses as $i => $discountclass): ?>
                                            <tr>
                                                <td><?php echo $discountclass['discount_id'];?></td>
                                                <td><?php echo $discountclass['discount_name'];?></td>
                                                <td><?php echo $discountclass['discount'];?>%</td>
                                                <td>
                                                    <div class="readmore less" id="desc">
                                                        <?php echo $discountclass['discount_description'];?>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-success btn-xs mb-3"
                                                        ...
                                                        title="View"
                                                        data-target="#view-<?php echo $discountclass['discount_id'];?>"><i
                                                            class="fa fa-eye"> </i> </button>
                                                    <!--View button start here-->

                                                    <!-- View MODAL STARTS HERE -->
                                                    <div class="modal fade"
                                                        id="view-<?php echo $discountclass['discount_id'];?>"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="staticBackdropLabel">View Discount </h5>
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="input-group mb-3">
                                                                                <div class="input-group-prepend">
                                                                                    <span
                                                                                        class="input-group-text">Discount
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    ...
                                                                                    id="workoutclass"
                                                                                    name="workoutclass <?php echo $discountclass['discount_id']; ?>"
                                                                                    disabled
                                                                                    value="<?php echo $discountclass['discount_id']; ?>">
                                                                            ...
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    ...
                                                                                    id="workoutclassname"
                                                                                    name="workoutclassname <?php echo $discountclass['discount_name']; ?>"
                                                                                    disabled
                                                                                    value="<?php echo $discountclass['discount_name']; ?>">
                                                                            </div>
                                                                            <div class="input-group mb-3">
                                                                                <div class="input-group-prepend">
                                                                                    <span class="input-group-text"
                                                                                        style="width: 150px;">Discount
                                                                                        Rate</span>
                                                                                </div>
                                                                                <input type="text" class="form-control"
                                                                                    aria-describedby="basic-addon3"
                                                                                    placeholder="Workout Name"
                                                                                    id="workoutclassname"
                                                                                    name="workoutclassname <?php echo $discountclass['discount']; ?>"
                                                                                    disabled
                                                                                    value="<?php echo $discountclass['discount']; ?>%">
                                                                            </div>
                                                                            <div class="input-group-prepend">
                                                                                <span
                                                                                    class="input-group-text">Description</span>
                                                                                <textarea type="text"
                                                                                    name="workoutclassdescription-<?php echo $discountclass['discount_description']; ?>"
                                                                                    disabled
                                                                                    class="form-control"><?php echo $discountclass['discount_description'];?></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-xs mb-3"
                                                        data-toggle="modal" data-toggle="tooltip" data-placement="top"
                                                        title="Edit"
                                                        data-target="#edit-<?php echo $discountclass['discount_id'];?>"><i
                                                    ...
                                                    <div class="modal fade" data-backdrop="static" data-keyboard="false"
                                                        ...
                                                        id="edit-<?php echo $discountclass['discount_id'];?>"
                                                        aria-hidden="true" style="display: none;" tabindex="-1"
                                                        role="dialog">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <form class="needs-validation" novalidate
                                                                action="../discount_class/editDiscount.php"
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-xs mb-3"
                                                        data-toggle="modal" data-toggle="tooltip" data-placement="top"
                                                        title="Delete"
                                                        data-target="#delete-<?php echo $discountclass['discount_id'];?>"><i
                                                            class="fa fa-trash"> </i> </button>
                                                    <!--Delete button start here-->

                                                    <!-- DELETE MODALS START HERE -->
                                                    <div id="delete-<?php echo $discountclass['discount_id'];?>"
                                                        ...
                                                        <div class="modal-dialog modal-confirm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer justify-content-center">
                                                                    <form class="d-inline"
                                                                        action="../discount_class/deletediscount.php"
                                                                        method="post">
                                    ...
                                    <div class="modal fade" id="add" aria-hidden="true" style="display: none;"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <form class="needs-validation" novalidate
                                                action="../discount_class/addDiscount.php" method="post">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <?php
                                                    ...
                                                    $a = new Admin();
                                                    ?>
                                                        <h5 class="modal-title" id="staticBackdropLabel">Add Discount
                                                        </h5>
                                                        <button type="button" class="close"
                                                            data-dismiss="modal"><span>×</span></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">Discount ID</span>
                                                                </div>
                                                                <input type="text" class="form-control"
                                                                    aria-describedby="basic-addon3" id="workoutclass"
                                                                    name="" value="<?php 
                                                    echo $a->generateDiscountId();?>" disabled>
                                                                <input type="hidden" class="form-control"
                                                                    aria-describedby="basic-addon3" id="discount_id"
                                                                    name="discount_id" value="<?php 
                                                    echo $a->generateDiscountId();?>">
                                                            </div>
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text"> Discount Name
                                                                        <span>&nbsp;</span><span style="color: red;"> *
                                                                        </span></span>
                                                                </div>
                                                                <input type="text" class="form-control" required
                                                                    aria-describedby="basic-addon3"
                                                                    placeholder="Discount Name" id="discountname"
                                                                    name="discountname">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text"
                                                                        style="width: 161px;"> Discount
                                                                        <span>&nbsp;</span><span style="color: red;"> *
                                                                        </span></span>
                                                                </div>
                                                                <input type="text" class="form-control" required
                                                                    aria-describedby="basic-addon3"
                                                                    placeholder="Discount" id="discount_price"
                                                                    name="discountprice"
                                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                                <div class="valid-feedback">
                                                                </div>
                                                            ...
                                                            <textarea class="form-control" aria-label="With textarea"
                                                                rows="5" name="discountdescription"
    ...
    <script>
    var input = document.getElementById('discount_price');
